...
// framework" — agent reference, dashboard, marking-out. Idea-specific
...
window.FORGE_CONFIG = (function () {
  ...
  const PIPELINE = [
    ...
    { id: 'marking-out',         n: '··', name: 'The Tracer',        file: 'product-team/marking-out.md',         phase: 'discovery' },
    ...
    { id: '08-heat-review',      n: '08', name: 'Heat Review',       file: 'product-team/08-heat-review.md',      phase: 'build' },
  ...
  const LATERAL = [
    { id: 'observer',       name: 'The Observer',      mode: 'Always on',  note: 'Fires after every handover. Critiques process, not outputs.',        file: 'product-team/observer.md'        },
